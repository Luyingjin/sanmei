...
using Sanmei_AirConditioner.Sessions;
using Sanmei_AirConditioner.Web.Controllers.Results;
using Sanmei_AirConditioner.Web.Models;
using Sanmei_AirConditioner.Web.Models.Account;
...
{
    public class AccountController : Sanmei_AirConditionerControllerBase
    {
