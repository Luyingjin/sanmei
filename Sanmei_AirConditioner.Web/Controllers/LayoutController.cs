...
using Sanmei_AirConditioner.Configuration.Ui;
using Sanmei_AirConditioner.Sessions;
using Sanmei_AirConditioner.Web.Models;
using Sanmei_AirConditioner.Web.Models.Layout;

namespace Sanmei_AirConditioner.Web.Controllers
{
    public class LayoutController : Sanmei_AirConditionerControllerBase
    {
