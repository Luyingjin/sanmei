...
﻿using Abp.Owin;
using Sanmei_AirConditioner.Api.Controllers;
using Sanmei_AirConditioner.Web;
...
namespace Sanmei_AirConditioner.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in Sanmei_AirConditionerWebModule)
