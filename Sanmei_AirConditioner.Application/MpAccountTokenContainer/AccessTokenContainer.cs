...
namespace Sanmei_AirConditioner.MpAccountTokenContainer
{
    ...
    public class AccessTokenContainer : BaseContainer<AccessTokenBag>, IAccessTokenContainer
    {
        ...
        public AccessTokenContainer(ICacheManager cacheManager, ILogger logger)
        {
        ...
        {
            return await Senparc.Weixin.MP.Containers.AccessTokenContainer.TryGetAccessTokenAsync(appId, appSecret, getNewToken);
        ...
        {
            return await Senparc.Weixin.MP.Containers.AccessTokenContainer.GetAccessTokenAsync(appId, getNewToken);
        ...
        {
            return await Senparc.Weixin.MP.Containers.AccessTokenContainer.GetAccessTokenResultAsync(appId, getNewToken);
