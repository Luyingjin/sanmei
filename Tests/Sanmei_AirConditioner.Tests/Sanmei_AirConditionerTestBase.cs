...
namespace Sanmei_AirConditioner.Tests
{
    public abstract class Sanmei_AirConditionerTestBase : AbpIntegratedTestBase<Sanmei_AirConditionerTestModule>
    {
        private DbConnection _hostDb;
        private Dictionary<int, DbConnection> _tenantDbs; //only used for db per tenant architecture

        protected Sanmei_AirConditionerTestBase()
        {
        ...
        protected void UsingDbContext(Action<Sanmei_AirConditionerDbContext> action)
        {
            UsingDbContext(AbpSession.TenantId, action);
        }

        protected Task UsingDbContextAsync(Func<Sanmei_AirConditionerDbContext, Task> action)
        {
            return UsingDbContextAsync(AbpSession.TenantId, action);
        }

        protected T UsingDbContext<T>(Func<Sanmei_AirConditionerDbContext, T> func)
        {
            return UsingDbContext(AbpSession.TenantId, func);
        }

        protected Task<T> UsingDbContextAsync<T>(Func<Sanmei_AirConditionerDbContext, Task<T>> func)
        {
            return UsingDbContextAsync(AbpSession.TenantId, func);
        }

        protected void UsingDbContext(int? tenantId, Action<Sanmei_AirConditionerDbContext> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<Sanmei_AirConditionerDbContext>())
                {
        ...
        protected async Task UsingDbContextAsync(int? tenantId, Func<Sanmei_AirConditionerDbContext, Task> action)
        {
            using (UsingTenantId(tenantId))
            {
                using (var context = LocalIocManager.Resolve<Sanmei_AirConditionerDbContext>())
        ...
        protected T UsingDbContext<T>(int? tenantId, Func<Sanmei_AirConditionerDbContext, T> func)
        {
            T result;
        ...
        protected async Task<T> UsingDbContextAsync<T>(int? tenantId, Func<Sanmei_AirConditionerDbContext, Task<T>> func)
        {
            T result;
